...
WSGI_APPLICATION = 'tuteur.wsgi.application'

# --- Base de données ---
# MySQL par défaut, fallback SQLite si les variables ne sont pas définies
...
GEMINI_SYSTEM_PROMPT = (
    ...
    "Tu adaptes tes explications au niveau de l'élève. "
